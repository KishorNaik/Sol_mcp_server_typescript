...
// #region Domain Event
export class TodoUpdatedDomainEvent extends NotificationData {
...
@sealed
@notificationHandler(TodoUpdatedDomainEvent)
export class TodoUpdatedDomainEventHandler implements NotificationHandler<TodoUpdatedDomainEvent> {
	...
	public async handle(notification: TodoUpdatedDomainEvent): Promise<void> {
		try {
			// Set Cache
